            ...
            <div class="w-full md:w-3/5 border-r shadow-md bg-white pr-4 py-4 rounded-lg mt-6">
                ...
                <div class="flex flex-col space-y-4 px-4">
                    ...
                    <div class="flex flex-col space-y-2">
                        <div class="mb-2 ml-4">
                            <p class="text-gray-900 text-xl font-bold font-Poppins">Harga Anak: <span class="text-teal-400 text-xl font-bold font-Poppins">Rp {{ number_format($tiket->harga_anak) }}</span> </p>
                            @if($tiket->harga_dewasa > 0)
